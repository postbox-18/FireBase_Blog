...
public class MainActivity extends AppCompatActivity {
   ...
   // Uri FilePathUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Descrp=(EditText)findViewById(R.id.Des);
            ...
            storageReference2nd.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            String Dsc = Descrp.getText().toString().trim();
                           ...
                           // final Uri firebaseUri = taskSnapshot.getUploadSessionUri();

                                    storageReference2nd.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
                                public void onSuccess(Uri uri) {
                                    String url = uri.toString();
                                    ImageUploadInfo imageUploadInfo = new ImageUploadInfo(TempImageName,Dsc,url);
